...
function runProgress(steps: WorkbenchState['run']['steps']): number {
...
function statusPillClass(status: WorkbenchState['run']['status']): string {
...
function statusLabel(status: WorkbenchState['run']['status']): string {
